...
cmd({
    ...
    try {
        await reply("🔍 Checking for X-BOT-MD updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your X-BOT-MD is already up-to-date!");
        }

        await reply("🚀 Updating X-MD Bot...");
        ...
        const sourcePath = path.join(extractPath, "X-BOT-MD-main");
